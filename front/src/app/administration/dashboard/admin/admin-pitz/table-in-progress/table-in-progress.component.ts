...
@Component({
  selector: "pitz-table-in-progress",
  templateUrl: "./table-in-progress.component.html",
  styleUrls: ["./table-in-progress.component.scss"],
})
export class TableInProgressComponent implements OnInit {
